...
public class Gui
{
    ...
    public static void drawRect(double left, double offset, double right, double d, int color)
    {
        ...
        worldrenderer.pos((double)left, (double)d, 0.0D).endVertex();
        worldrenderer.pos((double)right, (double)d, 0.0D).endVertex();
        worldrenderer.pos((double)right, (double)offset, 0.0D).endVertex();
        worldrenderer.pos((double)left, (double)offset, 0.0D).endVertex();
        tessellator.draw();
