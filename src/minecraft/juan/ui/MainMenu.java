...
public class MainMenu extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		mc.getTextureManager().bindTexture(new ResourceLocation("juan/juancover.jpg"));
		...
		for(String name : buttons) {
			...
			this.drawCenteredString(mc.fontRendererObj, name, width/buttons.length * count + width/buttons.length / 2f + 8, height - 20, hovered ? 0xff737373 : -1);
			count++;
		}
